...
<body>
    ...
    <main>
        <form method="GET" action="{{ route('search') }}"  class="main-container search-form">
            @csrf
            ...
            <div class="search-value">
                <input type="search" class="form-control" id="search_value" name="search_value" placeholder="Tìm kiếm" value={{ request()->get('search_value', '') }}>
            </div>
            <button type="submit" class="fa fa-search btn-search"></button>
        </form>
        <div class="chatbot">
            <button class="button_chatbot" aria-placeholder="click me!">
                <img class="image_chatbot" src="{{asset('storage/image/helping-icon-png-3.jpeg')}}" alt="" width="50" height="50">
        ...
        <div id="chatbox" class="box" style="display: none">
            <div>
                <div class="container-fluid m-0 d-flex p-2">
                    <div>
                        <img src="{{ asset('storage/image/helping-icon-png-3.jpeg') }}" alt="" width="30px" height="30px" style="object-fit: cover;">
                    </div>
                    <div class="text-black font-weight-bold ml-2 fs-6" style="align-self: center;">ChatBot</div>
                    <button id="button-close" type="button" class="close" aria-label="Close" style="margin-left: auto; margin-right: 10px;">
            ...
            <div class="container-fluid w-100 px-3 py-2 d-flex" style="background: #e7e9ec;height:48px;">
                <div class="mr-2 pl-2" style="background: white;width:calc(100% - 45px);border-radius:5px">
                    <input id="input" class="text-black" type="text" name="input" style="background: none; height:100%; width:100%; border:0; outline: none">
                </div>
                <div id="button-submit" class="text-center" style="background:#4acfee; height:100%; width:40px; border-radius:5px">
            ...
            <ul class="about-me">
                ...
                <li class="about-me-item">
                    ...
                    <ul class="connect-company">
                        ...
                        <li class="connect-company-item">
                            <a href="" class="sociated">
                                <img src="https://i.pinimg.com/736x/2c/da/19/2cda1925dcf4fb8f0644413f49671ffa.jpg" alt="Instagram">
                            </a>
                        </li>
                        <li class="connect-company-item">
                            <a href="" class="sociated">
                                <img src="https://cdn1.iconfinder.com/data/icons/logos-brands-in-colors/2500/zalo-seeklogo.com-512.png" alt="Zalo">
                            </a>
                        </li>
                    </ul>
