...
@section('content')
    <div class="container px-4">
        <div class="row gx-5 d-flex justify-content-center">
            <div class="col bg-light h-25 d-flex">
            ...
            <div class="col">
                <form enctype="multipart/form-data" action="{{route('schedule.store')}}" id="add-schedule"
                      method="post">
                    @csrf
                    <!-- Cinema Info -->
                    <div class="row mb-3">
                        ...
                        @if(Auth::user()->role_id==App\Models\User::ROLE_MANAGER)
                            <div class="col-md-6">
                                <input type="hidden" name="cinema_id" id="cinema_id" value="{{ $cinemas[0]->id }}"
                                       required/>
                                <input id="{{$cinemas[0]->id}}" type="text" readonly class="form-control" name="cinema"
                                       value="{{ $cinemas[0]->name }}">
                                @error('cinema_id')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            @if(Auth::user()->role_id==App\Models\User::ROLE_MANAGER)
                                <select class="form-control" name="room_id" required id="room"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <select class="form-control" name="movie_id"
                                    onchange="changeDate(options[selectedIndex].id)"
                                    required>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="start_at_input" defaultValue type="date" class="form-control" name="start_at"
                                   required>
                            @error('start_at')
                            <div class="error text-danger">{{$message}}</div>
                            @enderror
